...
const dynamicPageKeys = [
    ...
    "market-refresh",
    "market-refreshing",
    "market-refresh-success",
    "market-refresh-failed",
    "market-market-status",
    "market-no-listings",
    "market-mode-fixed-price",
    "market-mode-auction",
    "market-mode-offers",
    "market-buy",
    "market-bid",
    ...
    "market-listed",
    "market-points-suffix",
    "market-status-active",
    "market-status-sold",
    "market-status-cancelled",
    "market-status-expired",
    "market-status-outbid",
    "market-status-accepted",
    "market-status-rejected",
    "market-status-committed",
    "market-status-released",
    "market-frozen-points",
    "market-buy-confirm",
    "market-action-create-title",
    "market-action-bid-title",
    "market-action-offer-title",
    "market-action-mode",
    "market-action-amount",
    "market-action-price",
    "market-action-price-placeholder",
    "market-action-amount-placeholder",
    "market-action-submit-create",
    "market-action-submit-bid",
    "market-action-submit-offer",
    "market-action-hint-create",
    "market-action-hint-bid",
    "market-action-hint-offer",
    "market-action-error",
    "market-action-cancel-blocked",
    "market-action-cancel",
